...
copy api.js "%WORKER_DIR%\worker.js" >nul
...
set PYTHON_SCRIPT=..\scripts\generate_dashboard_data.py
...
echo.
echo Need help? Check the deployment guide: ml\web_dashboard\deployment_guide.md
echo.
