...
/**
 * Row passed to Recharts after merging prediction/volatility bands.
 * Index signature must include band tuple/array types alongside league price numbers.
 */
export type LeagueComparisonChartDataRow = {
  day: number;
  range: [number, number] | null;
  volatility_range: number[] | null;
  [leagueName: string]: number | [number, number] | number[] | null | undefined;
};
...
export function LeagueComparisonChart({
  ...
  const chartData = useMemo(() => {
    ...
    return displayData.map((row): LeagueComparisonChartDataRow => {
